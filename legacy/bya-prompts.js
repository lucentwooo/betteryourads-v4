/* bya-prompts.js — Stage 1 / Stage 2 prompt templates + mode rules.
   SOURCE OF TRUTH for the customer app. Byte-extracted verbatim from the original
   index.html (now admin.html). admin.html STILL keeps its own inline copy for now;
   when admin is migrated, delete that copy and load this file instead. Keep in sync. */
