// Standalone check for the product-fidelity helpers in bya-pipeline.js (the customer app).
...
const html = readFileSync(join(here, "..", "bya-pipeline.js"), "utf8");

const START = "// === product-fidelity helpers (start) ===";
const END = "// === product-fidelity helpers (end) ===";
const a = html.indexOf(START);
const b = html.indexOf(END);
assert.ok(a !== -1 && b !== -1 && b > a, "helper sentinels not found in bya-pipeline.js");
